    ...
    >
      ...
      >
        ...
        >
          ...
          {/* burada xl:bg-wihte dememizin sebebi large cihazlarda resmin üstüne geldiğimzde beyaz arka plan
          aksi durumlarda  normal rengi klıyor */}
          <br />
        ...
        >
          {statistics.map((stat) => (
            <div key={stat.label}>
              {/* key index vereceğimize bu şşkeilde stat.label da diyebiliriz o da unique bi değer */}
